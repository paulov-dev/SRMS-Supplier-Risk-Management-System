    ...
    return {
        ...
        actionPlanHistory: risk.actionPlanHistory.map(
            (history: any) => ({
                ...
                oldRequiredAction:
                    history.oldRequiredAction,
                newRequiredAction:
                    history.newRequiredAction,

                oldResponsibleArea:
                    history.oldResponsibleArea,
                newResponsibleArea:
                    history.newResponsibleArea,

                oldDueDate: history.oldDueDate,
                newDueDate: history.newDueDate,

                oldPriority: history.oldPriority,
                ...
                oldValidatedById:
                    history.oldValidatedById,
                newValidatedById:
                    history.newValidatedById,

                oldSubmittedAt: history.oldSubmittedAt,
                newSubmittedAt: history.newSubmittedAt,

                oldValidatedAt: history.oldValidatedAt,
                newValidatedAt: history.newValidatedAt,

                oldEvidenceUrl: history.oldEvidenceUrl,
                newEvidenceUrl: history.newEvidenceUrl,

                oldClosingNotes:
                    history.oldClosingNotes,
                newClosingNotes:
                    history.newClosingNotes,
                ...
                actionPlan: history.actionPlan
                    ? {
                          ...
                          title: history.actionPlan.title,
                          description:
                          ...
                          requiredAction:
                              history.actionPlan
                                  .requiredAction,
                          status:
                              history.actionPlan.status,
                          priority:
                              history.actionPlan.priority,
                      }
                    : null,
                ...
                riskEventPart: history.riskEventPart
                    ? {
                          ...
                          partNumber: {
                              id: history.riskEventPart
                                  .partNumber.id,
                              partNumber:
                                  history.riskEventPart
                                      .partNumber
                                      .partNumber,
                              description:
                                  history.riskEventPart
    ...
    try {
        ...
        if (
            ...
            return NextResponse.json(
                {
                    error:
                        "Informe o motivo para fechar, cancelar ou reabrir a RM.",
                },
                { status: 400 }
            )
        }
        ...
        const updatedRisk = await prisma.$transaction(
            async (tx) => {
                ...
                if (nextOpeningReason !== undefined) {
                    updateData.openingReason =
                        nextOpeningReason as any
                }
                    ...
                    await tx.riskStatusHistory.create({
                        data: {
                            ...
                            reason: nextAssignedToId
                                ...
                                : `Responsável removido. Responsável anterior: ${
                                      currentRisk.assignedTo
                                          ?.name ||
                                      "Sem responsável"
                                  }.`,
                    ...
                    await createNotification(tx, {
                        ...
                        message:
                            ...
                            RiskWorkflowStatus.CLOSED
                                ...
                                : nextWorkflowStatus ===
                                    RiskWorkflowStatus.CANCELED
                                  ? `A RM ${currentRisk.code} foi cancelada.`
